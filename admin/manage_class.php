...
<div class="container-fluid">
	<form action="" id="manage-class">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control form-control-sm" name="curriculum" id="curriculum" value="Level" required>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control form-control-sm disabled" name="section" id="section" value="<?php echo 'A'; ?>" required>
		</div>
